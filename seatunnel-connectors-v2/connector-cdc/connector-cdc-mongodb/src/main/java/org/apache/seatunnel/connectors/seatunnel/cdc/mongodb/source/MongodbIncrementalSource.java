...
public class MongodbIncrementalSource<T> extends IncrementalSource<T, MongodbSourceConfig>
    ...
    @Override
    public SourceConfig.Factory<MongodbSourceConfig> createSourceConfigFactory(ReadonlyConfig config) {
        MongodbIncrementalSourceFactory configFactory = new MongodbIncrementalSourceFactory();
